...
- `aarch64-apple-darwin` → `herdr-a2a-0.1.10-macos-arm64.tar.gz`
- `x86_64-apple-darwin` → `herdr-a2a-0.1.10-macos-x86_64.tar.gz`
- `aarch64-unknown-linux-gnu` → `herdr-a2a-0.1.10-linux-arm64.tar.gz`
- `x86_64-unknown-linux-gnu` → `herdr-a2a-0.1.10-linux-x86_64.tar.gz`
